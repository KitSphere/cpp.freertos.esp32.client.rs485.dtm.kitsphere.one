...
namespace FreeRTOS {
namespace CPP {
        OneKitphere::OneKitphere (uint8_t UartHardwareDriver, uint8_t TXPin, uint8_t RXPin, uint8_t RTSPin, uint8_t DataSize, uint8_t ParityBit, uint8_t StopBit, uint64_t BaudRate, uint64_t TxBufferSize, uint64_t RxBufferSize) {
                /***1***/
        ...
        int8_t  OneKitphere::s (std::string &E, std::vector<uint8_t> &S) { /*
                E: Error note
                D: Data
                RETURN:
        ...
        int8_t  OneKitphere::r (std::string &E, std::vector<uint8_t> &Y, uint64_t S, uint64_t T) { /*
                E: Errr note
                D: Data
                S: Data read length
                         0: Variable
